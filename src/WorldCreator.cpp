...
namespace Dungeon {
	...
	void WorldCreator::initTemplates() {
		...
		templates["creature/smallspider"] = createObject<Creature>("template/creature/smallspider/1", templateRoom)
				->drops(templates["resource/wood"], 32 * Dropper::Percent, 6 * ENEMY_MATS_DROP_RATE, 14 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/sand"], 23 * Dropper::Percent, 11 * ENEMY_MATS_DROP_RATE, 16 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/whitepowder"], 19  * Dropper::Percent, 6 * ENEMY_MATS_DROP_RATE, 9 * ENEMY_MATS_DROP_RATE)
				->drops(templates["potion/tinyred"], 8  * Dropper::Percent)
				->setAttack(5)
				->setDefense(3)
		...
		templates["creature/rat"] = createObject<Creature>("template/creature/rat/1", templateRoom)
				->drops(templates["resource/wood"], 31 * Dropper::Percent, 9 * ENEMY_MATS_DROP_RATE, 16 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/leather"], 40 * Dropper::Percent, 6 * ENEMY_MATS_DROP_RATE, 10 * ENEMY_MATS_DROP_RATE)
				->drops(templates["potion/tinyred"], 9 * Dropper::Percent)
				->setAttack(9)
				->setDefense(5)
		...
		templates["creature/raven"] = createObject<Creature>("template/creature/raven/1", templateRoom)
				->drops(templates["resource/sand"], 100 * Dropper::Percent, 11 * ENEMY_MATS_DROP_RATE, 20 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/whitepowder"], 80  * Dropper::Percent, 1 * ENEMY_MATS_DROP_RATE, 3 * ENEMY_MATS_DROP_RATE)
				->drops(templates["potion/tinyred"], 10 * Dropper::Percent)
				->setAttack(12)
				->setDefense(9)
		...
		templates["creature/snake"] = createObject<Creature>("template/creature/snake/1", templateRoom)
				->drops(templates["resource/wood"], 79 * Dropper::Percent, 3 * ENEMY_MATS_DROP_RATE, 7 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/iron"], 27 * Dropper::Percent, 4 * ENEMY_MATS_DROP_RATE, 16 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/leather"], 37 * Dropper::Percent, 7 * ENEMY_MATS_DROP_RATE, 11 * ENEMY_MATS_DROP_RATE)
				->drops(templates["potion/tinyred"], 11 * Dropper::Percent)
				->setAttack(16)
				->setDefense(11)
		...
		templates["creature/bigrat"] = createObject<Creature>("template/creature/bigrat/1", templateRoom)
				->drops(templates["resource/wood"], 90 * Dropper::Percent, 3 * ENEMY_MATS_DROP_RATE, 6 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/iron"], 51 * Dropper::Percent, 3 * ENEMY_MATS_DROP_RATE, 4 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/leather"], 66 * Dropper::Percent, 6 * ENEMY_MATS_DROP_RATE, 14 * ENEMY_MATS_DROP_RATE)
				->drops(templates["potion/tinyred"], 12 * Dropper::Percent)
				->setAttack(19)
				->setDefense(16)
				->setMaxHp(11 * ENEMY_HP_RATE)
				->setCurrentHp(11 * ENEMY_HP_RATE)
		...
		templates["creature/scorpion"] = createObject<Creature>("template/creature/scorpion/1", templateRoom)
				->drops(templates["resource/iron"], 28 * Dropper::Percent, 11 * ENEMY_MATS_DROP_RATE, 21 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/sand"], 62 * Dropper::Percent, 7 * ENEMY_MATS_DROP_RATE, 14 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/whitepowder"], 84  * Dropper::Percent, 7 * ENEMY_MATS_DROP_RATE, 13 * ENEMY_MATS_DROP_RATE)
				->drops(templates["potion/tinyred"], 13 * Dropper::Percent)
				->setAttack(22)
				->setDefense(19)
		...
		templates["creature/dog"] = createObject<Creature>("template/creature/dog/1", templateRoom)
				->drops(templates["resource/wood"], 63 * Dropper::Percent, 12 * ENEMY_MATS_DROP_RATE, 14 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/leather"], 93 * Dropper::Percent, 12 * ENEMY_MATS_DROP_RATE, 16 * ENEMY_MATS_DROP_RATE)
				->drops(templates["potion/tinyred"], 15 * Dropper::Percent)
				->setAttack(25)
				->setDefense(24)
		...
		templates["creature/bigspider"] = createObject<Creature>("template/creature/bigspider/1", templateRoom)
				->drops(templates["resource/iron"], 30 * Dropper::Percent, 10 * ENEMY_MATS_DROP_RATE, 24 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/iron"], 30 * Dropper::Percent, 10 * ENEMY_MATS_DROP_RATE, 24 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/iron"], 30 * Dropper::Percent, 10 * ENEMY_MATS_DROP_RATE, 24 * ENEMY_MATS_DROP_RATE)
				->drops(templates["potion/tinyred"], 18 * Dropper::Percent)
				->setAttack(28)
				->setDefense(30)
		...
		templates["creature/wolf"] = createObject<Creature>("template/creature/wolf/1", templateRoom)
				->drops(templates["resource/iron"], 60 * Dropper::Percent, 11 * ENEMY_MATS_DROP_RATE, 19 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/leather"], 69 * Dropper::Percent, 7 * ENEMY_MATS_DROP_RATE, 12 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/whitepowder"], 70  * Dropper::Percent, 7 * ENEMY_MATS_DROP_RATE, 12 * ENEMY_MATS_DROP_RATE)
				->drops(templates["potion/tinyred"], 20 * Dropper::Percent)
				->setAttack(31)
				->setDefense(37)
		...
		templates["creature/goblin"] = createObject<Creature>("template/creature/goblin/1", templateRoom)
				->drops(templates["resource/sand"], 100 * Dropper::Percent, 11 * ENEMY_MATS_DROP_RATE, 15 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/whitepowder"], 100  * Dropper::Percent, 10 * ENEMY_MATS_DROP_RATE, 23 * ENEMY_MATS_DROP_RATE)
				->drops(templates["potion/tinyred"], 23 * Dropper::Percent)
				->drops(templates["item/spiderkey"], ENEMY_BOSS_KEY_RATE * Dropper::Percent)
				->setAttack(37)
				->setDefense(43)
		...
		templates["creature/zombie"] = createObject<Creature>("template/creature/zombie/1", templateRoom)
				->drops(templates["resource/wood"], 100 * Dropper::Percent, 12 * ENEMY_MATS_DROP_RATE, 18 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/wood"], 36 * Dropper::Percent, 30 * ENEMY_MATS_DROP_RATE, 58 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/wood"], 3 * Dropper::Percent, 400 * ENEMY_MATS_DROP_RATE, 600 * ENEMY_MATS_DROP_RATE)
				->drops(templates["potion/tinyred"], 26 * Dropper::Percent)
				->setAttack(45)
				->setDefense(41)
		...
		templates["creature/skeleton"] = createObject<Creature>("template/creature/skeleton/1", templateRoom)
				->drops(templates["resource/iron"], 100 * Dropper::Percent, 7 * ENEMY_MATS_DROP_RATE, 9 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/iron"], 28 * Dropper::Percent, 26 * ENEMY_MATS_DROP_RATE, 32 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/iron"], 8 * Dropper::Percent, 90 * ENEMY_MATS_DROP_RATE, 114 * ENEMY_MATS_DROP_RATE)
				->drops(templates["potion/smallred"], 11 * Dropper::Percent)
				->setAttack(49)
				->setDefense(83)
		...
		templates["creature/mummy"] = createObject<Creature>("template/creature/mummy/1", templateRoom)
				->drops(templates["resource/leather"], 100 * Dropper::Percent, 8 * ENEMY_MATS_DROP_RATE, 12 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/leather"], 23 * Dropper::Percent, 38 * ENEMY_MATS_DROP_RATE, 49 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/leather"], 10 * Dropper::Percent, 90 * ENEMY_MATS_DROP_RATE, 100 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/redpowder"], 14 * Dropper::Percent, 5 * ENEMY_MATS_DROP_RATE, 9 * ENEMY_MATS_DROP_RATE)
				->drops(templates["potion/smallred"], 12 * Dropper::Percent)
				->setAttack(54)
				->setDefense(51)
		...
		templates["creature/thief"] = createObject<Creature>("template/creature/thief/1", templateRoom)
				->drops(templates["resource/iron"], 45 * Dropper::Percent, 30 * ENEMY_MATS_DROP_RATE, 50 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/wood"], 42 * Dropper::Percent, 52 * ENEMY_MATS_DROP_RATE, 62 * ENEMY_MATS_DROP_RATE)
				->drops(templates["potion/smallred"], 13 * Dropper::Percent)
				->setAttack(61)
				->setDefense(80)
		...
		templates["creature/orc"] = createObject<Creature>("template/creature/orc/1", templateRoom)
				->drops(templates["resource/iron"], 45 * Dropper::Percent, 30 * ENEMY_MATS_DROP_RATE, 50 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/wood"], 42 * Dropper::Percent, 52 * ENEMY_MATS_DROP_RATE, 62 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/redpowder"], 12 * Dropper::Percent, 7 * ENEMY_MATS_DROP_RATE, 8 * ENEMY_MATS_DROP_RATE)
				->drops(templates["potion/smallred"], 15 * Dropper::Percent)
				->setAttack(70)
				->setDefense(94)
		...
		templates["creature/grizzlybear"] = createObject<Creature>("template/creature/grizzlybear/1", templateRoom)
				->drops(templates["resource/sand"], 100 * Dropper::Percent, 40 * ENEMY_MATS_DROP_RATE, 60 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/whitepowder"], 100  * Dropper::Percent, 20 * ENEMY_MATS_DROP_RATE, 30 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/redpowder"], 100 * Dropper::Percent, 3 * ENEMY_MATS_DROP_RATE, 4 * ENEMY_MATS_DROP_RATE)
				->drops(templates["potion/smallred"], 16 * Dropper::Percent)
				->setAttack(81)
				->setDefense(70)
		...
		templates["creature/gnome"] = createObject<Creature>("template/creature/gnome/1", templateRoom)
				->drops(templates["resource/leather"], 70 * Dropper::Percent, 30 * ENEMY_MATS_DROP_RATE, 37 * ENEMY_MATS_DROP_RATE)
				->drops(templates["potion/smallred"], 18 * Dropper::Percent)
				->drops(templates["item/unicornkey"], ENEMY_BOSS_KEY_RATE * Dropper::Percent)
				->setAttack(86)
				->setDefense(98)
		...
		templates["creature/ghost"] = createObject<Creature>("template/creature/ghost/1", templateRoom)
				->drops(templates["resource/wood"], 50 * Dropper::Percent, 30 * ENEMY_MATS_DROP_RATE, 50 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/leather"], 40 * Dropper::Percent, 25 * ENEMY_MATS_DROP_RATE, 31 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/iron"], 35 * Dropper::Percent, 30 * ENEMY_MATS_DROP_RATE, 33 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/redpowder"], 70 * Dropper::Percent, 3 * ENEMY_MATS_DROP_RATE, 6 * ENEMY_MATS_DROP_RATE)
				->drops(templates["potion/smallred"], 20 * Dropper::Percent)
				->setAttack(99)
				->setDefense(34)
		...
		templates["creature/vampire"] = createObject<Creature>("template/creature/vampire/1", templateRoom)
				->drops(templates["resource/wood"], 46 * Dropper::Percent, 30 * ENEMY_MATS_DROP_RATE, 50 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/leather"], 39 * Dropper::Percent, 25 * ENEMY_MATS_DROP_RATE, 32 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/iron"], 47 * Dropper::Percent, 20 * ENEMY_MATS_DROP_RATE, 26 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/whitepowder"], 26 * Dropper::Percent, 40 * ENEMY_MATS_DROP_RATE, 60 * ENEMY_MATS_DROP_RATE)
				->drops(templates["potion/smallred"], 22 * Dropper::Percent)
				->setAttack(109)
				->setDefense(107)
		...
		templates["creature/giant"] = createObject<Creature>("template/creature/giant/1", templateRoom)
				->drops(templates["resource/wood"], 36 * Dropper::Percent, 40 * ENEMY_MATS_DROP_RATE, 50 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/leather"], 29 * Dropper::Percent, 30 * ENEMY_MATS_DROP_RATE, 54 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/iron"], 31 * Dropper::Percent, 50 * ENEMY_MATS_DROP_RATE, 67 * ENEMY_MATS_DROP_RATE)
				->drops(templates["potion/smallred"], 24 * Dropper::Percent)
				->setAttack(121)
				->setDefense(96)
		...
		templates["creature/spirit"] = createObject<Creature>("template/creature/spirit/1", templateRoom)
				->drops(templates["resource/sand"], 60 * Dropper::Percent, 60 * ENEMY_MATS_DROP_RATE, 69 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/whitepowder"], 47 * Dropper::Percent, 40 * ENEMY_MATS_DROP_RATE, 45 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/redpowder"], 23 * Dropper::Percent, 20 * ENEMY_MATS_DROP_RATE, 32 * ENEMY_MATS_DROP_RATE)
				->drops(templates["potion/smallred"], 26 * Dropper::Percent)
				->setAttack(129)
				->setDefense(55)
		...
		templates["creature/werewolf"] = createObject<Creature>("template/creature/werewolf/1", templateRoom)
				->drops(templates["resource/iron"], 33 * Dropper::Percent, 20 * ENEMY_MATS_DROP_RATE, 40 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/wood"], 36 * Dropper::Percent, 40 * ENEMY_MATS_DROP_RATE, 60 * ENEMY_MATS_DROP_RATE)
				->drops(templates["potion/smallred"], 28 * Dropper::Percent)
				->drops(templates["potion/bigred"], 10 * Dropper::Percent)
				->drops(templates["item/minotaurkey"], ENEMY_BOSS_KEY_RATE * Dropper::Percent)
				->setAttack(141)
				->setDefense(103)
		...
		templates["creature/ogre"] = createObject<Creature>("template/creature/ogre/1", templateRoom)
				->drops(templates["resource/iron"], 43 * Dropper::Percent, 35 * ENEMY_MATS_DROP_RATE, 68 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/wood"], 31 * Dropper::Percent, 50 * ENEMY_MATS_DROP_RATE, 70 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/dragonskin"], 26 * Dropper::Percent, 1 * ENEMY_MATS_DROP_RATE, 2 * ENEMY_MATS_DROP_RATE)
				->drops(templates["potion/red"], 11 * Dropper::Percent)
				->setAttack(149)
				->setDefense(117)
		...
		templates["creature/medusa"] = createObject<Creature>("template/creature/medusa/1", templateRoom)
				->drops(templates["resource/iron"], 25 * Dropper::Percent, 40 * ENEMY_MATS_DROP_RATE, 69 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/wood"], 22 * Dropper::Percent, 100 * ENEMY_MATS_DROP_RATE, 136 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/dragonskin"], 23 * Dropper::Percent, 4 * ENEMY_MATS_DROP_RATE, 6 * ENEMY_MATS_DROP_RATE)
				->drops(templates["potion/red"], 13 * Dropper::Percent)
				->setAttack(161)
				->setDefense(73)
		...
		templates["creature/troll"] = createObject<Creature>("template/creature/troll/1", templateRoom)
				->drops(templates["resource/whitepowder"], 66 * Dropper::Percent, 14 * ENEMY_MATS_DROP_RATE, 21 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/redpowder"], 55 * Dropper::Percent, 8 * ENEMY_MATS_DROP_RATE, 13 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/dragonskin"], 26 * Dropper::Percent, 3 * ENEMY_MATS_DROP_RATE, 5 * ENEMY_MATS_DROP_RATE)
				->drops(templates["potion/red"], 14 * Dropper::Percent)
				->drops(templates["item/hydrakey"], ENEMY_BOSS_KEY_RATE * Dropper::Percent)
				->setAttack(176)
				->setDefense(85)
		...
		templates["creature/cyclops"] = createObject<Creature>("template/creature/cyclops/1", templateRoom)
				->drops(templates["resource/dragonskin"], 29 * Dropper::Percent, 10 * ENEMY_MATS_DROP_RATE, 14 * ENEMY_MATS_DROP_RATE)
				->drops(templates["potion/red"], 16 * Dropper::Percent)
				->setAttack(188)
				->setDefense(233)
		...
		templates["creature/demon"] = createObject<Creature>("template/creature/demon/1", templateRoom)
				->drops(templates["resource/wood"], 9 * Dropper::Percent, 90 * ENEMY_MATS_DROP_RATE, 110 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/iron"], 19 * Dropper::Percent, 90 * ENEMY_MATS_DROP_RATE, 110 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/dragonskin"], 9 * Dropper::Percent, 9 * ENEMY_MATS_DROP_RATE, 11 * ENEMY_MATS_DROP_RATE)
				->drops(templates["potion/red"], 17 * Dropper::Percent)
				->drops(templates["item/dragonkey"], ENEMY_BOSS_KEY_RATE * Dropper::Percent)
				->setAttack(201)
				->setDefense(155)
		...
		templates["creature/spiderking"] = createObject<Creature>("template/creature/spiderking/1", templateRoom)
				->drops(templates["resource/leather"], Dropper::Always, 50 * ENEMY_MATS_DROP_RATE, 60 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/iron"], Dropper::Always, 40 * ENEMY_MATS_DROP_RATE, 50 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/wood"], Dropper::Always, 70 * ENEMY_MATS_DROP_RATE, 130 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/sand"], Dropper::Always, 60 * ENEMY_MATS_DROP_RATE, 75 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/whitepowder"], Dropper::Always, 60 * ENEMY_MATS_DROP_RATE, 75 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/magicalstone"], 20 * Dropper::Percent, 1 * ENEMY_MATS_DROP_RATE, 1 * ENEMY_MATS_DROP_RATE)
				->drops(templates["potion/tinyred"], 40 * Dropper::Percent, 2, 4)
				->drops(templates["potion/smallred"], 40 * Dropper::Percent, 1, 2)
				->setAttack(56)
				->setDefense(78)
		...
		templates["creature/unicorn"] = createObject<Creature>("template/creature/unicorn/1", templateRoom)
				->drops(templates["resource/leather"], Dropper::Always, 80 * ENEMY_MATS_DROP_RATE, 97 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/iron"], Dropper::Always, 60 * ENEMY_MATS_DROP_RATE, 85 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/wood"], Dropper::Always, 100 * ENEMY_MATS_DROP_RATE, 220 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/magicalstone"], 50 * Dropper::Percent, 1 * ENEMY_MATS_DROP_RATE, 3 * ENEMY_MATS_DROP_RATE)
				->drops(templates["potion/tinyred"], 100 * Dropper::Percent, 5, 15)
		...
		templates["creature/minotaur"] = createObject<Creature>("template/creature/minotaur/1", templateRoom)
				->drops(templates["resource/iron"], Dropper::Always, 60 * ENEMY_MATS_DROP_RATE, 85 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/wood"], Dropper::Always, 100 * ENEMY_MATS_DROP_RATE, 220 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/magicalstone"], 60 * Dropper::Percent, 2 * ENEMY_MATS_DROP_RATE, 4 * ENEMY_MATS_DROP_RATE)
				->drops(templates["potion/smallred"], 100 * Dropper::Percent, 7, 11)
				->drops(templates["potion/red"], 45 * Dropper::Percent, 2, 9)
				->drops(templates["potion/bigred"], 30 * Dropper::Percent, 1, 4)
				->drops(templates["inventory/hardleatherpack"], 10 * Dropper::Percent)
				->setAttack(174)
				->setDefense(245)
		...
		templates["creature/hydra"] = createObject<Creature>("template/creature/hydra/1", templateRoom)
				->drops(templates["resource/dragonskin"], Dropper::Always, 7 * ENEMY_MATS_DROP_RATE, 12 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/iron"], Dropper::Always, 60 * ENEMY_MATS_DROP_RATE, 85 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/wood"], Dropper::Always, 100 * ENEMY_MATS_DROP_RATE, 220 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/magicalstone"], 90 * Dropper::Percent, 2 * ENEMY_MATS_DROP_RATE, 5 * ENEMY_MATS_DROP_RATE)
				->drops(templates["potion/red"], 100 * Dropper::Percent, 5, 7)
		...
		templates["creature/dragon"] = createObject<Creature>("template/creature/dragon/1", templateRoom)
				->drops(templates["resource/dragonskin"], Dropper::Always, 7 * ENEMY_MATS_DROP_RATE, 10 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/redpowder"], Dropper::Always, 10 * ENEMY_MATS_DROP_RATE, 15 * ENEMY_MATS_DROP_RATE)
				->drops(templates["resource/magicalstone"], Dropper::Always, 3 * ENEMY_MATS_DROP_RATE, 6 * ENEMY_MATS_DROP_RATE)
				->drops(templates["inventory/endragonleatherpack"], 10 * Dropper::Percent)
				->drops(templates["wearable/ensteelsword"], 10 * Dropper::Percent)
				->setAttack(293)
				->setDefense(511)
