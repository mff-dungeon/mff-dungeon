...
namespace Dungeon {
	...
	void WorldCreator::initTemplates() {
		...
		templates["recipe/woodenaxe"] = createObject<Recipe>("template/recipe/woodenaxe/1")
				->setExperience(15 * Config::RecipeExp())
				->setLevel(1)
				->setResource(Resource::Wood, 30 * Config::RecipeMat())
		...
		templates["recipe/club"] = createObject<Recipe>("template/recipe/club/1")
				->setExperience(25 * Config::RecipeExp())
				->setLevel(3)
				->setResource(Resource::Wood, 50 * Config::RecipeMat())
		...
		templates["recipe/irondagger"] = createObject<Recipe>("template/recipe/irondagger/1")
				->setExperience(22 * Config::RecipeExp())
				->setLevel(6)
				->setResource(Resource::Wood, 10 * Config::RecipeMat())
				->setResource(Resource::Iron, 15 * Config::RecipeMat())
		...
		templates["recipe/ironspear"] = createObject<Recipe>("template/recipe/ironspear/1")
				->setExperience(21 * Config::RecipeExp())
				->setLevel(10)
				->setResource(Resource::Wood, 30 * Config::RecipeMat())
				->setResource(Resource::Iron, 5 * Config::RecipeMat())
		...
		templates["recipe/ironsword"] = createObject<Recipe>("template/recipe/ironsword/1")
				->setExperience(50 * Config::RecipeExp())
				->setLevel(13)
				->setResource(Resource::Wood, 23 * Config::RecipeMat())
				->setResource(Resource::Iron, 35 * Config::RecipeMat())
		...
		templates["recipe/ironmace"] = createObject<Recipe>("template/recipe/ironmace/1")
				->setExperience(76 * Config::RecipeExp())
				->setLevel(16)
				->setResource(Resource::Wood, 30 * Config::RecipeMat())
				->setResource(Resource::Iron, 55 * Config::RecipeMat())
		...
		templates["recipe/ironhammer"] = createObject<Recipe>("template/recipe/ironhammer/1")
				->setExperience(138 * Config::RecipeExp())
				->setLevel(19)
				->setResource(Resource::Wood, 55 * Config::RecipeMat())
				->setResource(Resource::Iron, 100 * Config::RecipeMat())
		...
		templates["recipe/enironspear"] = createObject<Recipe>("template/recipe/enironspear/1")
				->setExperience(86 * Config::RecipeExp())
				->setLevel(24)
				->setResource(Resource::Wood, 50 * Config::RecipeMat())
				->setResource(Resource::Iron, 10 * Config::RecipeMat())
				->setResource(Resource::MagicalStone, 1 * Config::RecipeMat())
		...
		templates["recipe/enironsword"] = createObject<Recipe>("template/recipe/enironsword/1")
				->setExperience(117 * Config::RecipeExp())
				->setLevel(30)
				->setResource(Resource::Wood, 35 * Config::RecipeMat())
				->setResource(Resource::Iron, 45 * Config::RecipeMat())
				->setResource(Resource::MagicalStone, 1 * Config::RecipeMat())
		...
		templates["recipe/steelspear"] = createObject<Recipe>("template/recipe/steelspear/1")
				->setExperience(44 * Config::RecipeExp())
				->setLevel(33)
				->setResource(Resource::Wood, 60 * Config::RecipeMat())
				->setResource(Resource::Iron, 12 * Config::RecipeMat())
		...
		templates["recipe/steelsword"] = createObject<Recipe>("template/recipe/steelsword/1")
				->setExperience(101 * Config::RecipeExp())
				->setLevel(38)
				->setResource(Resource::Wood, 70 * Config::RecipeMat())
				->setResource(Resource::Iron, 60 * Config::RecipeMat())
		...
		templates["recipe/steelmace"] = createObject<Recipe>("template/recipe/steelmace/1")
				->setExperience(154 * Config::RecipeExp())
				->setLevel(43)
				->setResource(Resource::Wood, 110 * Config::RecipeMat())
				->setResource(Resource::Iron, 90 * Config::RecipeMat())
		...
		templates["recipe/steelhammer"] = createObject<Recipe>("template/recipe/steelhammer/1")
				->setExperience(255 * Config::RecipeExp())
				->setLevel(48)
				->setResource(Resource::Wood, 180 * Config::RecipeMat())
				->setResource(Resource::Iron, 150 * Config::RecipeMat())
		...
		templates["recipe/ensteelspear"] = createObject<Recipe>("template/recipe/ensteelspear/1")
				->setExperience(393 * Config::RecipeExp())
				->setLevel(54)
				->setResource(Resource::Wood, 120 * Config::RecipeMat())
				->setResource(Resource::Iron, 30 * Config::RecipeMat())
				->setResource(Resource::MagicalStone, 6 * Config::RecipeMat())
		...
		templates["recipe/ensteelsword"] = createObject<Recipe>("template/recipe/ensteelsword/1")
				->setExperience(460 * Config::RecipeExp())
				->setLevel(60)
				->setResource(Resource::Wood, 100 * Config::RecipeMat())
				->setResource(Resource::Iron, 100 * Config::RecipeMat())
				->setResource(Resource::MagicalStone, 6 * Config::RecipeMat())
		...
		templates["recipe/tinyred"] = createObject<Recipe>("template/recipe/tinyred/1")
				->setExperience(2 * Config::RecipeExp())
				->setLevel(4)
				->setResource(Resource::Sand, 2 * Config::RecipeMat())
				->setResource(Resource::WhitePowder, 1 * Config::RecipeMat())
		...
		templates["recipe/smallred"] = createObject<Recipe>("template/recipe/smallred/1")
				->setExperience(4 * Config::RecipeExp())
				->setLevel(11)
				->setResource(Resource::Sand, 5 * Config::RecipeMat())
				->setResource(Resource::WhitePowder, 3 * Config::RecipeMat())
		...
		templates["recipe/red"] = createObject<Recipe>("template/recipe/red/1")
				->setExperience(10 * Config::RecipeExp())
				->setLevel(22)
				->setResource(Resource::Sand, 10 * Config::RecipeMat())
				->setResource(Resource::WhitePowder, 7 * Config::RecipeMat())
				->setResource(Resource::RedPowder, 1 * Config::RecipeMat())
		...
		templates["recipe/bigred"] = createObject<Recipe>("template/recipe/bigred/1")
				->setExperience(16 * Config::RecipeExp())
				->setLevel(34)
				->setResource(Resource::Sand, 20 * Config::RecipeMat())
				->setResource(Resource::WhitePowder, 10 * Config::RecipeMat())
				->setResource(Resource::RedPowder, 2 * Config::RecipeMat())
		...
		templates["recipe/largered"] = createObject<Recipe>("template/recipe/largered/1")
				->setExperience(28 * Config::RecipeExp())
				->setLevel(53)
				->setResource(Resource::Sand, 28 * Config::RecipeMat())
				->setResource(Resource::WhitePowder, 16 * Config::RecipeMat())
				->setResource(Resource::RedPowder, 5 * Config::RecipeMat())
		...
		templates["recipe/leatherbody"] = createObject<Recipe>("template/recipe/leatherbody/1")
				->setExperience(23 * Config::RecipeExp())
				->setLevel(7)
				->setResource(Resource::Leather, 25 * Config::RecipeMat())
		...
		templates["recipe/hardleatherbody"] = createObject<Recipe>("template/recipe/hardleatherbody/1")
				->setExperience(41 * Config::RecipeExp())
				->setLevel(17)
				->setResource(Resource::Leather, 45 * Config::RecipeMat())
		...
		templates["recipe/ironbody"] = createObject<Recipe>("template/recipe/ironbody/1")
				->setExperience(194 * Config::RecipeExp())
				->setLevel(31)
				->setResource(Resource::Wood, 80 * Config::RecipeMat())
				->setResource(Resource::Iron, 140 * Config::RecipeMat())
		...
		templates["recipe/steelbody"] = createObject<Recipe>("template/recipe/steelbody/1")
				->setExperience(320 * Config::RecipeExp())
				->setLevel(46)
				->setResource(Resource::Wood, 200 * Config::RecipeMat())
				->setResource(Resource::Iron, 200 * Config::RecipeMat())
		...
		templates["recipe/dragonbody"] = createObject<Recipe>("template/recipe/dragonbody/1")
				->setExperience(450 * Config::RecipeExp())
				->setLevel(59)
				->setResource(Resource::DragonSkin, 30 * Config::RecipeMat())
				->setResource(Resource::MagicalStone, 3 * Config::RecipeMat())
		...
		templates["recipe/leatherhelm"] = createObject<Recipe>("template/recipe/leatherhelm/1")
				->setExperience(9 * Config::RecipeExp())
				->setLevel(5)
				->setResource(Resource::Leather, 9 * Config::RecipeMat())
		...
		templates["recipe/hardleatherhelm"] = createObject<Recipe>("template/recipe/hardleatherhelm/1")
				->setExperience(15 * Config::RecipeExp())
				->setLevel(14)
				->setResource(Resource::Leather, 16 * Config::RecipeMat())
		...
		templates["recipe/ironhelm"] = createObject<Recipe>("template/recipe/ironhelm/1")
				->setExperience(65 * Config::RecipeExp())
				->setLevel(28)
				->setResource(Resource::Wood, 20 * Config::RecipeMat())
				->setResource(Resource::Iron, 50 * Config::RecipeMat())
		...
		templates["recipe/steelhelm"] = createObject<Recipe>("template/recipe/steelhelm/1")
				->setExperience(128 * Config::RecipeExp())
				->setLevel(44)
				->setResource(Resource::Wood, 80 * Config::RecipeMat())
				->setResource(Resource::Iron, 80 * Config::RecipeMat())
		...
		templates["recipe/dragonhelm"] = createObject<Recipe>("template/recipe/dragonhelm/1")
				->setExperience(170 * Config::RecipeExp())
				->setLevel(58)
				->setResource(Resource::DragonSkin, 12 * Config::RecipeMat())
				->setResource(Resource::MagicalStone, 1 * Config::RecipeMat())
		...
		templates["recipe/leathergloves"] = createObject<Recipe>("template/recipe/leathergloves/1")
				->setExperience(7 * Config::RecipeExp())
				->setLevel(3)
				->setResource(Resource::Leather, 7 * Config::RecipeMat())
		...
		templates["recipe/hardleathergloves"] = createObject<Recipe>("template/recipe/hardleathergloves/1")
				->setExperience(12 * Config::RecipeExp())
				->setLevel(12)
				->setResource(Resource::Leather, 13 * Config::RecipeMat())
		...
		templates["recipe/irongloves"] = createObject<Recipe>("template/recipe/irongloves/1")
				->setExperience(52 * Config::RecipeExp())
				->setLevel(26)
				->setResource(Resource::Wood, 16 * Config::RecipeMat())
				->setResource(Resource::Iron, 40 * Config::RecipeMat())
		...
		templates["recipe/steelgloves"] = createObject<Recipe>("template/recipe/steelgloves/1")
				->setExperience(112 * Config::RecipeExp())
				->setLevel(41)
				->setResource(Resource::Wood, 70 * Config::RecipeMat())
				->setResource(Resource::Iron, 70 * Config::RecipeMat())
		...
		templates["recipe/dragongloves"] = createObject<Recipe>("template/recipe/dragongloves/1")
				->setExperience(130 * Config::RecipeExp())
				->setLevel(56)
				->setResource(Resource::DragonSkin, 8 * Config::RecipeMat())
				->setResource(Resource::MagicalStone, 1 * Config::RecipeMat())
		...
		templates["recipe/crudewoodshield"] = createObject<Recipe>("template/recipe/crudewoodshield/1")
				->setExperience(13 * Config::RecipeExp())
				->setLevel(2)
				->setResource(Resource::Wood, 25 * Config::RecipeMat())
		...
		templates["recipe/ironshield"] = createObject<Recipe>("template/recipe/ironshield/1")
				->setExperience(70 * Config::RecipeExp())
				->setLevel(24)
				->setResource(Resource::Wood, 30 * Config::RecipeMat())
				->setResource(Resource::Iron, 50 * Config::RecipeMat())
		...
		templates["recipe/steelshield"] = createObject<Recipe>("template/recipe/steelshield/1")
				->setExperience(192 * Config::RecipeExp())
				->setLevel(39)
				->setResource(Resource::Wood, 120 * Config::RecipeMat())
				->setResource(Resource::Iron, 120 * Config::RecipeMat())
		...
		templates["recipe/ensteelshield"] = createObject<Recipe>("template/recipe/ensteelshield/1")
				->setExperience(445 * Config::RecipeExp())
				->setLevel(55)
				->setResource(Resource::Wood, 250 * Config::RecipeMat())
				->setResource(Resource::Iron, 200 * Config::RecipeMat())
				->setResource(Resource::MagicalStone, 2 * Config::RecipeMat())
		...
		templates["recipe/leatherpack"] = createObject<Recipe>("template/recipe/leatherpack/1")
				->setExperience(5 * Config::RecipeExp())
				->setLevel(5)
				->setResource(Resource::Leather, 5 * Config::RecipeMat())
		...
		templates["recipe/bigleatherpack"] = createObject<Recipe>("template/recipe/bigleatherpack/1")
				->setExperience(17 * Config::RecipeExp())
				->setLevel(11)
				->setResource(Resource::Leather, 18 * Config::RecipeMat())
		...
		templates["recipe/hardleatherpack"] = createObject<Recipe>("template/recipe/hardleatherpack/1")
				->setExperience(50 * Config::RecipeExp())
				->setLevel(27)
				->setResource(Resource::Leather, 55 * Config::RecipeMat())
		...
		templates["recipe/dragonleatherpack"] = createObject<Recipe>("template/recipe/dragonleatherpack/1")
				->setExperience(350 * Config::RecipeExp())
				->setLevel(41)
				->setResource(Resource::DragonSkin, 25 * Config::RecipeMat())
				->setResource(Resource::MagicalStone, 2 * Config::RecipeMat())
		...
		templates["recipe/endragonleatherpack"] = createObject<Recipe>("template/recipe/endragonleatherpack/1")
				->setExperience(1050 * Config::RecipeExp())
				->setLevel(62)
				->setResource(Resource::DragonSkin, 55 * Config::RecipeMat())
				->setResource(Resource::MagicalStone, 10 * Config::RecipeMat())
		...
		templates["recipe/spiderkey"] = createObject<Recipe>("template/recipe/spiderkey/1")
				->setExperience(22 * Config::RecipeExp())
				->setLevel(23)
				->setResource(Resource::Wood, 60 * Config::RecipeKeyMat())
				->setResource(Resource::Iron, 100 * Config::RecipeKeyMat())
				->setResource(Resource::WhitePowder, 40 * Config::RecipeKeyMat())
				->setResource(Resource::MagicalStone, 1 * Config::RecipeKeyMat())
		...
		templates["recipe/unicornkey"] = createObject<Recipe>("template/recipe/unicornkey/1")
				->setExperience(49 * Config::RecipeExp())
				->setLevel(36)
				->setResource(Resource::Wood, 150 * Config::RecipeKeyMat())
				->setResource(Resource::Iron, 200 * Config::RecipeKeyMat())
				->setResource(Resource::WhitePowder, 70 * Config::RecipeKeyMat())
				->setResource(Resource::MagicalStone, 2 * Config::RecipeKeyMat())
		...
		templates["recipe/minotaurkey"] = createObject<Recipe>("template/recipe/minotaurkey/1")
				->setExperience(88 * Config::RecipeExp())
				->setLevel(51)
				->setResource(Resource::Wood, 300 * Config::RecipeKeyMat())
				->setResource(Resource::Iron, 300 * Config::RecipeKeyMat())
				->setResource(Resource::WhitePowder, 110 * Config::RecipeKeyMat())
				->setResource(Resource::RedPowder, 15 * Config::RecipeKeyMat())
				->setResource(Resource::MagicalStone, 4 * Config::RecipeKeyMat())
		...
		templates["recipe/hydrakey"] = createObject<Recipe>("template/recipe/hydrakey/1")
				->setExperience(155 * Config::RecipeExp())
				->setLevel(65)
				->setResource(Resource::Wood, 600 * Config::RecipeKeyMat())
				->setResource(Resource::Iron, 500 * Config::RecipeKeyMat())
				->setResource(Resource::WhitePowder, 200 * Config::RecipeKeyMat())
				->setResource(Resource::RedPowder, 40 * Config::RecipeKeyMat())
				->setResource(Resource::MagicalStone, 6 * Config::RecipeKeyMat())
		...
		templates["recipe/dragonkey"] = createObject<Recipe>("template/recipe/dragonkey/1")
				->setExperience(257 * Config::RecipeExp())
				->setLevel(79)
				->setResource(Resource::Wood, 1200 * Config::RecipeKeyMat())
				->setResource(Resource::Iron, 800 * Config::RecipeKeyMat())
				->setResource(Resource::WhitePowder, 300 * Config::RecipeKeyMat())
				->setResource(Resource::RedPowder, 80 * Config::RecipeKeyMat())
				->setResource(Resource::MagicalStone, 9 * Config::RecipeKeyMat())
		...
		templates["creature/smallspider"] = createObject<Creature>("template/creature/smallspider/1", templateRoom)
				->drops(shallowCloneTemplate(templates["resource/wood"]), 32 * Dropper::Percent, 6 * Config::EnemyMatsDrop(), 14 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/sand"]), 23 * Dropper::Percent, 11 * Config::EnemyMatsDrop(), 16 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/whitepowder"]), 19  * Dropper::Percent, 6 * Config::EnemyMatsDrop(), 9 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["potion/tinyred"]), 8  * Dropper::Percent)
				->setAttack(5)
				->setDefense(3)
				->setMaxHp(4 * Config::EnemyHp())
				->setCurrentHp(4 * Config::EnemyHp())
		...
		templates["creature/rat"] = createObject<Creature>("template/creature/rat/1", templateRoom)
				->drops(shallowCloneTemplate(templates["resource/wood"]), 31 * Dropper::Percent, 9 * Config::EnemyMatsDrop(), 16 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/leather"]), 40 * Dropper::Percent, 6 * Config::EnemyMatsDrop(), 10 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["potion/tinyred"]), 9 * Dropper::Percent)
				->setAttack(9)
				->setDefense(5)
				->setMaxHp(5 * Config::EnemyHp())
				->setCurrentHp(5 * Config::EnemyHp())
				->setRespawnInterval(12 * Config::EnemyRespawn())
		...
		templates["creature/raven"] = createObject<Creature>("template/creature/raven/1", templateRoom)
				->drops(shallowCloneTemplate(templates["resource/sand"]), 100 * Dropper::Percent, 11 * Config::EnemyMatsDrop(), 20 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/whitepowder"]), 80  * Dropper::Percent, 1 * Config::EnemyMatsDrop(), 3 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["potion/tinyred"]), 10 * Dropper::Percent)
				->setAttack(12)
				->setDefense(9)
				->setMaxHp(8 * Config::EnemyHp())
				->setCurrentHp(8 * Config::EnemyHp())
				->setRespawnInterval(12 * Config::EnemyRespawn())
		...
		templates["creature/snake"] = createObject<Creature>("template/creature/snake/1", templateRoom)
				->drops(shallowCloneTemplate(templates["resource/wood"]), 79 * Dropper::Percent, 3 * Config::EnemyMatsDrop(), 7 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/iron"]), 27 * Dropper::Percent, 4 * Config::EnemyMatsDrop(), 16 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/leather"]), 37 * Dropper::Percent, 7 * Config::EnemyMatsDrop(), 11 * Config::EnemyMatsDrop())
		...
		templates["creature/bigrat"] = createObject<Creature>("template/creature/bigrat/1", templateRoom)
				->drops(shallowCloneTemplate(templates["resource/wood"]), 90 * Dropper::Percent, 3 * Config::EnemyMatsDrop(), 6 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/iron"]), 51 * Dropper::Percent, 3 * Config::EnemyMatsDrop(), 4 * Config::EnemyMatsDrop())
		...
		templates["creature/scorpion"] = createObject<Creature>("template/creature/scorpion/1", templateRoom)
				->drops(shallowCloneTemplate(templates["resource/iron"]), 28 * Dropper::Percent, 11 * Config::EnemyMatsDrop(), 21 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/sand"]), 62 * Dropper::Percent, 7 * Config::EnemyMatsDrop(), 14 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/whitepowder"]), 84  * Dropper::Percent, 7 * Config::EnemyMatsDrop(), 13 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["potion/tinyred"]), 13 * Dropper::Percent)
				->setAttack(22)
				->setDefense(19)
				->setMaxHp(20 * Config::EnemyHp())
				->setCurrentHp(20 * Config::EnemyHp())
				->setRespawnInterval(12 * Config::EnemyRespawn())
		...
		templates["creature/dog"] = createObject<Creature>("template/creature/dog/1", templateRoom)
				->drops(shallowCloneTemplate(templates["resource/wood"]), 63 * Dropper::Percent, 12 * Config::EnemyMatsDrop(), 14 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/leather"]), 93 * Dropper::Percent, 12 * Config::EnemyMatsDrop(), 16 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["potion/tinyred"]), 15 * Dropper::Percent)
				->setAttack(25)
				->setDefense(24)
				->setMaxHp(22 * Config::EnemyHp())
				->setCurrentHp(22 * Config::EnemyHp())
				->setRespawnInterval(12 * Config::EnemyRespawn())
		...
		templates["creature/bigspider"] = createObject<Creature>("template/creature/bigspider/1", templateRoom)
				->drops(shallowCloneTemplate(templates["resource/iron"]), 30 * Dropper::Percent, 10 * Config::EnemyMatsDrop(), 24 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/iron"]), 30 * Dropper::Percent, 10 * Config::EnemyMatsDrop(), 24 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/iron"]), 30 * Dropper::Percent, 10 * Config::EnemyMatsDrop(), 24 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["potion/tinyred"]), 18 * Dropper::Percent)
				->setAttack(28)
				->setDefense(30)
				->setMaxHp(34 * Config::EnemyHp())
				->setCurrentHp(34 * Config::EnemyHp())
				->setRespawnInterval(12 * Config::EnemyRespawn())
				->setWeaponName("")
				->setName("Big spider")
				->setLongName("...")
		...
		templates["creature/wolf"] = createObject<Creature>("template/creature/wolf/1", templateRoom)
				->drops(shallowCloneTemplate(templates["resource/iron"]), 60 * Dropper::Percent, 11 * Config::EnemyMatsDrop(), 19 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/leather"]), 69 * Dropper::Percent, 7 * Config::EnemyMatsDrop(), 12 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/whitepowder"]), 70  * Dropper::Percent, 7 * Config::EnemyMatsDrop(), 12 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["potion/tinyred"]), 20 * Dropper::Percent)
				->setAttack(31)
				->setDefense(37)
				->setMaxHp(47 * Config::EnemyHp())
				->setCurrentHp(47 * Config::EnemyHp())
				->setRespawnInterval(12 * Config::EnemyRespawn())
				->setWeaponName("...")
				->setName("Wolf")
				->setLongName("...")
		...
		templates["creature/goblin"] = createObject<Creature>("template/creature/goblin/1", templateRoom)
				->drops(shallowCloneTemplate(templates["resource/sand"]), 100 * Dropper::Percent, 11 * Config::EnemyMatsDrop(), 15 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/whitepowder"]), 100  * Dropper::Percent, 10 * Config::EnemyMatsDrop(), 23 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["potion/tinyred"]), 23 * Dropper::Percent)
				->drops(shallowCloneTemplate(templates["item/spiderkey"]), Config::EnemyBossKey() * Dropper::Percent)
				->setAttack(37)
				->setDefense(43)
				->setMaxHp(51 * Config::EnemyHp())
				->setCurrentHp(51 * Config::EnemyHp())
				->setRespawnInterval(12 * Config::EnemyRespawn())
				->setWeaponName("...")
				->setName("Goblin")
				->setLongName("...")
		...
		templates["creature/zombie"] = createObject<Creature>("template/creature/zombie/1", templateRoom)
				->drops(shallowCloneTemplate(templates["resource/wood"]), 100 * Dropper::Percent, 12 * Config::EnemyMatsDrop(), 18 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/wood"]), 36 * Dropper::Percent, 30 * Config::EnemyMatsDrop(), 58 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/wood"]), 3 * Dropper::Percent, 400 * Config::EnemyMatsDrop(), 600 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["potion/tinyred"]), 26 * Dropper::Percent)
				->setAttack(45)
				->setDefense(41)
				->setMaxHp(82 * Config::EnemyHp())
				->setCurrentHp(82 * Config::EnemyHp())
				->setRespawnInterval(12 * Config::EnemyRespawn())
				->setWeaponName("...")
				->setName("Zombie")
				->setLongName("...")
		...
		templates["creature/skeleton"] = createObject<Creature>("template/creature/skeleton/1", templateRoom)
				->drops(shallowCloneTemplate(templates["resource/iron"]), 100 * Dropper::Percent, 7 * Config::EnemyMatsDrop(), 9 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/iron"]), 28 * Dropper::Percent, 26 * Config::EnemyMatsDrop(), 32 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/iron"]), 8 * Dropper::Percent, 90 * Config::EnemyMatsDrop(), 114 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["potion/smallred"]), 11 * Dropper::Percent)
				->setAttack(49)
				->setDefense(83)
				->setMaxHp(49 * Config::EnemyHp())
				->setCurrentHp(49 * Config::EnemyHp())
				->setRespawnInterval(12 * Config::EnemyRespawn())
				->setWeaponName("...")
				->setName("Skeleton")
				->setLongName("...")
		...
		templates["creature/mummy"] = createObject<Creature>("template/creature/mummy/1", templateRoom)
				->drops(shallowCloneTemplate(templates["resource/leather"]), 100 * Dropper::Percent, 8 * Config::EnemyMatsDrop(), 12 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/leather"]), 23 * Dropper::Percent, 38 * Config::EnemyMatsDrop(), 49 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/leather"]), 10 * Dropper::Percent, 90 * Config::EnemyMatsDrop(), 100 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/redpowder"]), 14 * Dropper::Percent, 5 * Config::EnemyMatsDrop(), 9 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["potion/smallred"]), 12 * Dropper::Percent)
				->setAttack(54)
				->setDefense(51)
				->setMaxHp(94 * Config::EnemyHp())
				->setCurrentHp(94 * Config::EnemyHp())
				->setRespawnInterval(12 * Config::EnemyRespawn())
				->setWeaponName("...")
				->setName("Mummy")
				->setLongName("...")
		...
		templates["creature/thief"] = createObject<Creature>("template/creature/thief/1", templateRoom)
				->drops(shallowCloneTemplate(templates["resource/iron"]), 45 * Dropper::Percent, 30 * Config::EnemyMatsDrop(), 50 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/wood"]), 42 * Dropper::Percent, 52 * Config::EnemyMatsDrop(), 62 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["potion/smallred"]), 13 * Dropper::Percent)
				->setAttack(61)
				->setDefense(80)
				->setMaxHp(65 * Config::EnemyHp())
				->setCurrentHp(65 * Config::EnemyHp())
				->setRespawnInterval(12 * Config::EnemyRespawn())
				->setWeaponName("...")
				->setName("Thief")
				->setLongName("...")
		...
		templates["creature/orc"] = createObject<Creature>("template/creature/orc/1", templateRoom)
				->drops(shallowCloneTemplate(templates["resource/iron"]), 45 * Dropper::Percent, 30 * Config::EnemyMatsDrop(), 50 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/wood"]), 42 * Dropper::Percent, 52 * Config::EnemyMatsDrop(), 62 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/redpowder"]), 12 * Dropper::Percent, 7 * Config::EnemyMatsDrop(), 8 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["potion/smallred"]), 15 * Dropper::Percent)
				->setAttack(70)
				->setDefense(94)
				->setMaxHp(67 * Config::EnemyHp())
				->setCurrentHp(67 * Config::EnemyHp())
				->setRespawnInterval(12 * Config::EnemyRespawn())
				->setWeaponName("...")
				->setName("Orc")
				->setLongName("...")
		...
		templates["creature/grizzlybear"] = createObject<Creature>("template/creature/grizzlybear/1", templateRoom)
				->drops(shallowCloneTemplate(templates["resource/sand"]), 100 * Dropper::Percent, 40 * Config::EnemyMatsDrop(), 60 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/whitepowder"]), 100  * Dropper::Percent, 20 * Config::EnemyMatsDrop(), 30 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/redpowder"]), 100 * Dropper::Percent, 3 * Config::EnemyMatsDrop(), 4 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["potion/smallred"]), 16 * Dropper::Percent)
				->setAttack(81)
				->setDefense(70)
				->setMaxHp(88 * Config::EnemyHp())
				->setCurrentHp(88 * Config::EnemyHp())
				->setRespawnInterval(12 * Config::EnemyRespawn())
				->setWeaponName("...")
		...
		templates["creature/gnome"] = createObject<Creature>("template/creature/gnome/1", templateRoom)
				->drops(shallowCloneTemplate(templates["resource/leather"]), 70 * Dropper::Percent, 30 * Config::EnemyMatsDrop(), 37 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["potion/smallred"]), 18 * Dropper::Percent)
				->drops(shallowCloneTemplate(templates["item/unicornkey"]), Config::EnemyBossKey() * Dropper::Percent)
				->setAttack(86)
				->setDefense(98)
				->setMaxHp(64 * Config::EnemyHp())
				->setCurrentHp(64 * Config::EnemyHp())
				->setRespawnInterval(12 * Config::EnemyRespawn())
				->setWeaponName("...")
				->setName("Gnome")
				->setLongName("...")
		...
		templates["creature/ghost"] = createObject<Creature>("template/creature/ghost/1", templateRoom)
				->drops(shallowCloneTemplate(templates["resource/wood"]), 50 * Dropper::Percent, 30 * Config::EnemyMatsDrop(), 50 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/leather"]), 40 * Dropper::Percent, 25 * Config::EnemyMatsDrop(), 31 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/iron"]), 35 * Dropper::Percent, 30 * Config::EnemyMatsDrop(), 33 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/redpowder"]), 70 * Dropper::Percent, 3 * Config::EnemyMatsDrop(), 6 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["potion/smallred"]), 20 * Dropper::Percent)
				->setAttack(99)
				->setDefense(34)
				->setMaxHp(176 * Config::EnemyHp())
				->setCurrentHp(176 * Config::EnemyHp())
				->setRespawnInterval(12 * Config::EnemyRespawn())
				->setWeaponName("...")
				->setName("Ghost")
				->setLongName("...")
		...
		templates["creature/vampire"] = createObject<Creature>("template/creature/vampire/1", templateRoom)
				->drops(shallowCloneTemplate(templates["resource/wood"]), 46 * Dropper::Percent, 30 * Config::EnemyMatsDrop(), 50 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/leather"]), 39 * Dropper::Percent, 25 * Config::EnemyMatsDrop(), 32 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/iron"]), 47 * Dropper::Percent, 20 * Config::EnemyMatsDrop(), 26 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/whitepowder"]), 26 * Dropper::Percent, 40 * Config::EnemyMatsDrop(), 60 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["potion/smallred"]), 22 * Dropper::Percent)
				->setAttack(109)
				->setDefense(107)
				->setMaxHp(73 * Config::EnemyHp())
				->setCurrentHp(73 * Config::EnemyHp())
				->setRespawnInterval(12 * Config::EnemyRespawn())
				->setWeaponName("...")
				->setName("Vampire")
				->setLongName("...")
		...
		templates["creature/giant"] = createObject<Creature>("template/creature/giant/1", templateRoom)
				->drops(shallowCloneTemplate(templates["resource/wood"]), 36 * Dropper::Percent, 40 * Config::EnemyMatsDrop(), 50 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/leather"]), 29 * Dropper::Percent, 30 * Config::EnemyMatsDrop(), 54 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/iron"]), 31 * Dropper::Percent, 50 * Config::EnemyMatsDrop(), 67 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["potion/smallred"]), 24 * Dropper::Percent)
				->setAttack(121)
				->setDefense(96)
				->setMaxHp(139 * Config::EnemyHp())
				->setCurrentHp(139 * Config::EnemyHp())
				->setRespawnInterval(15 * Config::EnemyRespawn())
				->setWeaponName("...")
				->setName("Giant")
				->setLongName("...")
				->setDescription("...")
		...
		templates["creature/spirit"] = createObject<Creature>("template/creature/spirit/1", templateRoom)
				->drops(shallowCloneTemplate(templates["resource/sand"]), 60 * Dropper::Percent, 60 * Config::EnemyMatsDrop(), 69 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/whitepowder"]), 47 * Dropper::Percent, 40 * Config::EnemyMatsDrop(), 45 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/redpowder"]), 23 * Dropper::Percent, 20 * Config::EnemyMatsDrop(), 32 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["potion/smallred"]), 26 * Dropper::Percent)
				->setAttack(129)
				->setDefense(55)
				->setMaxHp(191 * Config::EnemyHp())
				->setCurrentHp(191 * Config::EnemyHp())
				->setRespawnInterval(15 * Config::EnemyRespawn())
				->setWeaponName("...")
				->setName("Spirit")
				->setLongName("...")
		...
		templates["creature/werewolf"] = createObject<Creature>("template/creature/werewolf/1", templateRoom)
				->drops(shallowCloneTemplate(templates["resource/iron"]), 33 * Dropper::Percent, 20 * Config::EnemyMatsDrop(), 40 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/wood"]), 36 * Dropper::Percent, 40 * Config::EnemyMatsDrop(), 60 * Config::EnemyMatsDrop())
				...
				->drops(shallowCloneTemplate(templates["item/minotaurkey"]), Config::EnemyBossKey() * Dropper::Percent)
				->setAttack(141)
				->setDefense(103)
				->setMaxHp(156 * Config::EnemyHp())
				->setCurrentHp(156 * Config::EnemyHp())
				->setRespawnInterval(15 * Config::EnemyRespawn())
				->setWeaponName("...")
				->setName("Werewolf")
				->setLongName("...")
		...
		templates["creature/ogre"] = createObject<Creature>("template/creature/ogre/1", templateRoom)
				->drops(shallowCloneTemplate(templates["resource/iron"]), 43 * Dropper::Percent, 35 * Config::EnemyMatsDrop(), 68 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/wood"]), 31 * Dropper::Percent, 50 * Config::EnemyMatsDrop(), 70 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/dragonskin"]), 26 * Dropper::Percent, 1 * Config::EnemyMatsDrop(), 2 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["potion/red"]), 11 * Dropper::Percent)
				->setAttack(149)
				->setDefense(117)
				->setMaxHp(148 * Config::EnemyHp())
				->setCurrentHp(148 * Config::EnemyHp())
				->setRespawnInterval(15 * Config::EnemyRespawn())
				->setWeaponName("...")
				->setName("Ogre")
				->setLongName("...")
		...
		templates["creature/medusa"] = createObject<Creature>("template/creature/medusa/1", templateRoom)
				->drops(shallowCloneTemplate(templates["resource/iron"]), 25 * Dropper::Percent, 40 * Config::EnemyMatsDrop(), 69 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/wood"]), 22 * Dropper::Percent, 100 * Config::EnemyMatsDrop(), 136 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/dragonskin"]), 23 * Dropper::Percent, 4 * Config::EnemyMatsDrop(), 6 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["potion/red"]), 13 * Dropper::Percent)
				->setAttack(161)
				->setDefense(73)
				->setMaxHp(204 * Config::EnemyHp())
				->setCurrentHp(204 * Config::EnemyHp())
				->setRespawnInterval(15 * Config::EnemyRespawn())
				->setWeaponName("...")
		...
		templates["creature/troll"] = createObject<Creature>("template/creature/troll/1", templateRoom)
				->drops(shallowCloneTemplate(templates["resource/whitepowder"]), 66 * Dropper::Percent, 14 * Config::EnemyMatsDrop(), 21 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/redpowder"]), 55 * Dropper::Percent, 8 * Config::EnemyMatsDrop(), 13 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/dragonskin"]), 26 * Dropper::Percent, 3 * Config::EnemyMatsDrop(), 5 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["potion/red"]), 14 * Dropper::Percent)
				->drops(shallowCloneTemplate(templates["item/hydrakey"]), Config::EnemyBossKey() * Dropper::Percent)
				->setAttack(176)
				->setDefense(85)
				->setMaxHp(315 * Config::EnemyHp())
				->setCurrentHp(315 * Config::EnemyHp())
				->setRespawnInterval(18 * Config::EnemyRespawn())
				->setWeaponName("...")
				->setName("Troll")
				->setLongName("...")
				->setDescription("...")
		...
		templates["creature/cyclops"] = createObject<Creature>("template/creature/cyclops/1", templateRoom)
				->drops(shallowCloneTemplate(templates["resource/dragonskin"]), 29 * Dropper::Percent, 10 * Config::EnemyMatsDrop(), 14 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["potion/red"]), 16 * Dropper::Percent)
				->setAttack(188)
				->setDefense(233)
				->setMaxHp(136 * Config::EnemyHp())
				->setCurrentHp(136 * Config::EnemyHp())
				->setRespawnInterval(18 * Config::EnemyRespawn())
				->setWeaponName("...")
				->setName("Cyclops")
				->setLongName("...")
		...
		templates["creature/demon"] = createObject<Creature>("template/creature/demon/1", templateRoom)
				->drops(shallowCloneTemplate(templates["resource/wood"]), 9 * Dropper::Percent, 90 * Config::EnemyMatsDrop(), 110 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/iron"]), 19 * Dropper::Percent, 90 * Config::EnemyMatsDrop(), 110 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/dragonskin"]), 9 * Dropper::Percent, 9 * Config::EnemyMatsDrop(), 11 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["potion/red"]), 17 * Dropper::Percent)
				->drops(shallowCloneTemplate(templates["item/dragonkey"]), Config::EnemyBossKey() * Dropper::Percent)
				->setAttack(201)
				->setDefense(155)
				->setMaxHp(320 * Config::EnemyHp())
				->setCurrentHp(320 * Config::EnemyHp())
				->setRespawnInterval(18 * Config::EnemyRespawn())
				->setWeaponName("...")
				->setName("Demon")
				->setLongName("...")
		...
		templates["creature/spiderking"] = createObject<Creature>("template/creature/spiderking/1", templateRoom)
				->drops(shallowCloneTemplate(templates["resource/leather"]), Dropper::Always, 50 * Config::EnemyMatsDrop(), 60 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/iron"]), Dropper::Always, 40 * Config::EnemyMatsDrop(), 50 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/wood"]), Dropper::Always, 70 * Config::EnemyMatsDrop(), 130 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/sand"]), Dropper::Always, 60 * Config::EnemyMatsDrop(), 75 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/whitepowder"]), Dropper::Always, 60 * Config::EnemyMatsDrop(), 75 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/magicalstone"]), 20 * Dropper::Percent, 1 * Config::EnemyMatsDrop(), 1 * Config::EnemyMatsDrop())
				...
				->setAttack(56)
				->setDefense(78)
				->setMaxHp(75 * Config::EnemyHp())
				->setCurrentHp(75 * Config::EnemyHp())
				->setRespawnInterval(135 * Config::EnemyRespawn())
				->setWeaponName("...")
				->setName("Spider King")
				->setLongName("...")
				->setDescription("...")
		...
		templates["creature/unicorn"] = createObject<Creature>("template/creature/unicorn/1", templateRoom)
				->drops(shallowCloneTemplate(templates["resource/leather"]), Dropper::Always, 80 * Config::EnemyMatsDrop(), 97 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/iron"]), Dropper::Always, 60 * Config::EnemyMatsDrop(), 85 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/wood"]), Dropper::Always, 100 * Config::EnemyMatsDrop(), 220 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/magicalstone"]), 50 * Dropper::Percent, 1 * Config::EnemyMatsDrop(), 3 * Config::EnemyMatsDrop())
				...
				->setAttack(117)
				->setDefense(139)
				->setMaxHp(180 * Config::EnemyHp())
				->setCurrentHp(180 * Config::EnemyHp())
				->setRespawnInterval(180 * Config::EnemyRespawn())
				->setWeaponName("...")
				->setName("Unicorn")
				->setLongName("...")
				->setDescription("...")
		...
		templates["creature/minotaur"] = createObject<Creature>("template/creature/minotaur/1", templateRoom)
				->drops(shallowCloneTemplate(templates["resource/iron"]), Dropper::Always, 60 * Config::EnemyMatsDrop(), 85 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/wood"]), Dropper::Always, 100 * Config::EnemyMatsDrop(), 220 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/magicalstone"]), 60 * Dropper::Percent, 2 * Config::EnemyMatsDrop(), 4 * Config::EnemyMatsDrop())
				...
				->setAttack(174)
				->setDefense(245)
				->setMaxHp(265 * Config::EnemyHp())
				->setCurrentHp(265 * Config::EnemyHp())
				->setRespawnInterval(225 * Config::EnemyRespawn())
				->setWeaponName("...")
				->setName("Minotaur")
				->setLongName("...")
				->setDescription("...")
		...
		templates["creature/hydra"] = createObject<Creature>("template/creature/hydra/1", templateRoom)
				->drops(shallowCloneTemplate(templates["resource/dragonskin"]), Dropper::Always, 7 * Config::EnemyMatsDrop(), 12 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/iron"]), Dropper::Always, 60 * Config::EnemyMatsDrop(), 85 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/wood"]), Dropper::Always, 100 * Config::EnemyMatsDrop(), 220 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/magicalstone"]), 90 * Dropper::Percent, 2 * Config::EnemyMatsDrop(), 5 * Config::EnemyMatsDrop())
				...
				->setAttack(219)
				->setDefense(373)
				->setMaxHp(388 * Config::EnemyHp())
				->setCurrentHp(388 * Config::EnemyHp())
				->setRespawnInterval(270 * Config::EnemyRespawn())
				->setWeaponName("...")
				->setName("Hydra")
				->setLongName("...")
				->setDescription("...")
		...
		templates["creature/dragon"] = createObject<Creature>("template/creature/dragon/1", templateRoom)
				->drops(shallowCloneTemplate(templates["resource/dragonskin"]), Dropper::Always, 7 * Config::EnemyMatsDrop(), 10 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/redpowder"]), Dropper::Always, 10 * Config::EnemyMatsDrop(), 15 * Config::EnemyMatsDrop())
				->drops(shallowCloneTemplate(templates["resource/magicalstone"]), Dropper::Always, 3 * Config::EnemyMatsDrop(), 6 * Config::EnemyMatsDrop())
				...
				->setAttack(293)
				->setDefense(511)
				->setMaxHp(554 * Config::EnemyHp())
				->setCurrentHp(554 * Config::EnemyHp())
				->setRespawnInterval(360 * Config::EnemyRespawn())
				->setWeaponName("...")
				->setName("Dragon")
				->setLongName("...")
				->setDescription("...")
